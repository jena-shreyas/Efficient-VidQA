...
parser.add_argument('-m', '--mistake_path', help='Mistakes path', required=True)
...
try:
    ...
    MODEL = T5ForConditionalGeneration.from_pretrained("t5-base", return_dict=True) # large
    TOKENIZER = T5TokenizerFast.from_pretrained("t5-base")  # large
...
'''
    TODO: CHANGE THE DATA FILE FOR EACH TYPE !!!!!!!!!!
'''

DATA_PATH = args.data_path
# data = pd.read_csv('/scratch/jenas/dataset3/plan_data.csv')
data = pd.read_csv(DATA_PATH)
data = data.applymap(str)

# data = pd.read_csv('/scratch/jenas/CRIPP-VQA/Aloe-star/data/add_test_split.csv')
# data = data.applymap(str)
...
accuracy = accuracy_metric(test_data, MISTAKE_PATH)
